...
<div className="service">
            ...
            <div className="DecService_color">
              ...
              <div className="Dec_Service_Secone">
                <div className="Color_cons">
                  <div className="consultation">
                    <h4>Buttocks Waxing</h4>
                    <span>20min.Female only</span>
                    <text>£20</text>
                  </div>
                </div>
              ...
              <div className="Dec_Service_Secone">
                <div className="Color_cons">
                  <div className="consultation">
                    <h4>Hollywood Waxing</h4>
                    <span>35min-35min</span>
                    <text>£43</text>
                  </div>
                </div>
                <div className="Add_Button">
              ...
              <div className="Dec_Service_Secone">
                <div className="Color_cons">
                  <div className="consultation">
                    <h4>Back, Nexk + Shoulders Waxing</h4>
                    <span> 30min</span>
                    <text>£37</text>
                  </div>
                </div>
