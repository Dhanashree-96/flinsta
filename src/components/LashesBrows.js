...
<div className="service">
            ...
            <div className="DecService_color">
              ...
              <div className="Dec_Service_Secone">
                <div className="Color_cons">
                  <div className="consultation">
                    <h4>Classic Individual Lash Extension</h4>
                    <span>1h 15min </span>
                    <text>£86</text>
                  </div>
                </div>
